...
class AuthLoaded implements AuthState {
  const AuthLoaded(this.user, this.message);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthLoaded&&(identical(other.user, user) || other.user == user)&&(identical(other.message, message) || other.message == message));
}
...
@useResult
$Res call({
 AuthEntity user, String message
});
...
class AuthError implements AuthState {
  const AuthError({required this.message, this.title});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthError&&(identical(other.message, message) || other.message == message)&&(identical(other.title, title) || other.title == title));
}
